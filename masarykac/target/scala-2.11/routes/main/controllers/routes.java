...
// @DATE:Thu May 18 01:08:32 CEST 2017
...
public class routes {
  ...
  public static final controllers.ReverseCommitteeController CommitteeController = new controllers.ReverseCommitteeController(RoutesPrefix.byNamePrefix());
  ...
  public static final controllers.ReverseFinalWorksController FinalWorksController = new controllers.ReverseFinalWorksController(RoutesPrefix.byNamePrefix());
  ...
  public static final controllers.ReverseIdeasController IdeasController = new controllers.ReverseIdeasController(RoutesPrefix.byNamePrefix());
  ...
  public static class javascript {
    ...
    public static final controllers.javascript.ReverseCommitteeController CommitteeController = new controllers.javascript.ReverseCommitteeController(RoutesPrefix.byNamePrefix());
    ...
    public static final controllers.javascript.ReverseFinalWorksController FinalWorksController = new controllers.javascript.ReverseFinalWorksController(RoutesPrefix.byNamePrefix());
    ...
    public static final controllers.javascript.ReverseIdeasController IdeasController = new controllers.javascript.ReverseIdeasController(RoutesPrefix.byNamePrefix());
