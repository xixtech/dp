...
class Routes(
  ...
  // @LINE:111
  private[this] lazy val controllers_PersonalStatisticController_listTableTeachingAccordingToId76_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("teaching/t/"), DynamicPart("email", """[^/]+""",true)))
  )
  private[this] lazy val controllers_PersonalStatisticController_listTableTeachingAccordingToId76_invoker = createInvoker(
  ...
  // @LINE:113
  private[this] lazy val controllers_TeachersController_index77_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("teachers/add")))
  )
  private[this] lazy val controllers_TeachersController_index77_invoker = createInvoker(
  ...
  // @LINE:114
  private[this] lazy val controllers_TeachersController_save78_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("teachers/saved")))
  )
  private[this] lazy val controllers_TeachersController_save78_invoker = createInvoker(
  ...
  // @LINE:117
  private[this] lazy val controllers_MethodicsController_index79_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("m/add")))
  )
  private[this] lazy val controllers_MethodicsController_index79_invoker = createInvoker(
  ...
  // @LINE:118
  private[this] lazy val controllers_MethodicsController_save80_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("m/saved")))
  )
  private[this] lazy val controllers_MethodicsController_save80_invoker = createInvoker(
  ...
  // @LINE:120
  private[this] lazy val controllers_Application_roles81_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("roles")))
  )
  private[this] lazy val controllers_Application_roles81_invoker = createInvoker(
  ...
  // @LINE:123
  private[this] lazy val controllers_TableController_listPerson82_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("users")))
  )
  private[this] lazy val controllers_TableController_listPerson82_invoker = createInvoker(
  ...
  // @LINE:125
  private[this] lazy val controllers_SubjectPlanTeachingController_index83_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("sub/add")))
  )
  private[this] lazy val controllers_SubjectPlanTeachingController_index83_invoker = createInvoker(
  ...
  // @LINE:126
  private[this] lazy val controllers_SubjectPlanTeachingController_save84_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("sub/saved")))
  )
  private[this] lazy val controllers_SubjectPlanTeachingController_save84_invoker = createInvoker(
  ...
  // @LINE:129
  private[this] lazy val controllers_Application_logout85_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("logout")))
  )
  private[this] lazy val controllers_Application_logout85_invoker = createInvoker(
  ...
  // @LINE:132
  private[this] lazy val controllers_PrintController_printUserDetails86_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("users/moje/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_PrintController_printUserDetails86_invoker = createInvoker(
  ...
  // @LINE:133
  private[this] lazy val controllers_PrintController_detailsList87_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("users/moje/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_PrintController_detailsList87_invoker = createInvoker(
  ...
  // @LINE:135
  private[this] lazy val controllers_SalaryController_saveLector88_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("users/lector/saved")))
  )
  private[this] lazy val controllers_SalaryController_saveLector88_invoker = createInvoker(
  ...
  // @LINE:136
  private[this] lazy val controllers_SalaryController_printLector89_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("users/lector/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_SalaryController_printLector89_invoker = createInvoker(
  ...
  // @LINE:137
  private[this] lazy val controllers_SalaryController_detailsListLector90_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("users/lector/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_SalaryController_detailsListLector90_invoker = createInvoker(
  ...
  // @LINE:141
  private[this] lazy val controllers_Assets_at91_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("assets/"), DynamicPart("file", """.+""",false)))
  )
  private[this] lazy val controllers_Assets_at91_invoker = createInvoker(
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:111
    case controllers_PersonalStatisticController_listTableTeachingAccordingToId76_route(params) =>
      call(params.fromPath[String]("email", None)) { (email) =>
        controllers_PersonalStatisticController_listTableTeachingAccordingToId76_invoker.call(PersonalStatisticController_14.listTableTeachingAccordingToId(email))
      }
  
    // @LINE:113
    case controllers_TeachersController_index77_route(params) =>
      call { 
        controllers_TeachersController_index77_invoker.call(TeachersController_9.index())
      }
  
    // @LINE:114
    case controllers_TeachersController_save78_route(params) =>
      call { 
        controllers_TeachersController_save78_invoker.call(TeachersController_9.save())
      }
  
    // @LINE:117
    case controllers_MethodicsController_index79_route(params) =>
      call { 
        controllers_MethodicsController_index79_invoker.call(MethodicsController_0.index())
      }
  
    // @LINE:118
    case controllers_MethodicsController_save80_route(params) =>
      call { 
        controllers_MethodicsController_save80_invoker.call(MethodicsController_0.save())
      }
  
    // @LINE:120
    case controllers_Application_roles81_route(params) =>
      call { 
        controllers_Application_roles81_invoker.call(Application_26.roles())
      }
  
    // @LINE:123
    case controllers_TableController_listPerson82_route(params) =>
      call { 
        controllers_TableController_listPerson82_invoker.call(TableController_17.listPerson())
      }
  
    // @LINE:125
    case controllers_SubjectPlanTeachingController_index83_route(params) =>
      call { 
        controllers_SubjectPlanTeachingController_index83_invoker.call(SubjectPlanTeachingController_10.index())
      }
  
    // @LINE:126
    case controllers_SubjectPlanTeachingController_save84_route(params) =>
      call { 
        controllers_SubjectPlanTeachingController_save84_invoker.call(SubjectPlanTeachingController_10.save())
      }
  
    // @LINE:129
    case controllers_Application_logout85_route(params) =>
      call { 
        controllers_Application_logout85_invoker.call(Application_26.logout())
      }
  
    // @LINE:132
    case controllers_PrintController_printUserDetails86_route(params) =>
      call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_PrintController_printUserDetails86_invoker.call(PrintController_18.printUserDetails(id))
      }
  
    // @LINE:133
    case controllers_PrintController_detailsList87_route(params) =>
      call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_PrintController_detailsList87_invoker.call(PrintController_18.detailsList(id))
      }
  
    // @LINE:135
    case controllers_SalaryController_saveLector88_route(params) =>
      call { 
        controllers_SalaryController_saveLector88_invoker.call(SalaryController_16.saveLector())
      }
  
    // @LINE:136
    case controllers_SalaryController_printLector89_route(params) =>
      call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_SalaryController_printLector89_invoker.call(SalaryController_16.printLector(id))
      }
  
    // @LINE:137
    case controllers_SalaryController_detailsListLector90_route(params) =>
      call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_SalaryController_detailsListLector90_invoker.call(SalaryController_16.detailsListLector(id))
      }
  
    // @LINE:141
    case controllers_Assets_at91_route(params) =>
      call(Param[String]("path", Right("/public")), params.fromPath[String]("file", None)) { (path, file) =>
        controllers_Assets_at91_invoker.call(Assets_24.at(path, file))
      }
  }
}
