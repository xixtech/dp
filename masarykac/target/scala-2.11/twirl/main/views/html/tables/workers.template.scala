                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            """),_display_(/*50.30*/for(member <- currentPage) yield /*50.56*/ {_display_(Seq[Any](format.raw/*50.58*/("""
                                """),format.raw/*51.33*/("""<tr>
                                    ...
                                    """),format.raw/*78.37*/("""</td>
                                    <td class="center">
                                    """),_display_(/*80.38*/form(routes.PrintController.printLector(member.id), 'class -> "topRight")/*80.111*/ {_display_(Seq[Any](format.raw/*80.113*/("""
