                            ...
                            """),_display_(/*50.30*/for(member <- currentPage) yield /*50.56*/ {_display_(Seq[Any](format.raw/*50.58*/("""
                                """),format.raw/*51.33*/("""<tr>
                                    ...
                                    <td class="center">
                                        ...
                                        """),format.raw/*76.41*/("""<input type="submit" value=""""),_display_(/*76.70*/member/*76.76*/.email),format.raw/*76.82*/("""" class="btn success">
                                        """)))}),format.raw/*77.42*/("""
                                    """),format.raw/*78.37*/("""</td>
                                    <td class="center">
                                    """),_display_(/*80.38*/form(routes.SalaryController.printLector(member.id), 'class -> "topRight")/*80.112*/ {_display_(Seq[Any](format.raw/*80.114*/("""
                                        """),format.raw/*81.41*/("""<input type="submit" value=""""),_display_(/*81.70*/member/*81.76*/.email),format.raw/*81.82*/("""" class="btn success">
                                        """)))}),format.raw/*82.42*/("""
                                    """),format.raw/*83.37*/("""</td>
                                </tr>
                            """)))}),format.raw/*85.30*/("""
                            """),format.raw/*86.29*/("""</tbody>
                        </table>
                    </div>
                        <!-- /.table-responsive -->
                </div>
