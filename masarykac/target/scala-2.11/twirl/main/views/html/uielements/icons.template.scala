...
class icons extends BaseScalaTemplate[play.twirl.api.HtmlFormat.Appendable,Format[play.twirl.api.HtmlFormat.Appendable]](play.twirl.api.HtmlFormat) with play.twirl.api.Template0[play.twirl.api.HtmlFormat.Appendable] {
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">All available icons</div>
                <div class="panel-body">
                    <div class="row">
                        <div class="fa col-lg-3">
                            ...
                            <p class="fa fa-member"> fa-member </p><br/>
                        ...
                        <div class="fa col-lg-3">
                            ...
                            <p class="fa fa-member-md"> fa-member-md </p><br/>
                            ...
                            <p class="""),
format.raw(""""fa fa-h-square"> fa-h-square </p><br/>
                        ...
                        <div class="fa col-lg-3">
                           ...
                           """),
format.raw(""" <p class="fa fa-share-alt"> fa-share-alt </p><br/>
...
object icons extends icons_Scope0.icons
              /*
                  ...
                  SOURCE: E:/Users/Martin/Downloads/masarykac/app/views/uielements/icons.scala.html
