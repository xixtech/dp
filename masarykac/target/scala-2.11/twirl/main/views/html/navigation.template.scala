...
Seq[Any](format.raw/*1.4*/("""
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        ...
        <ul class="nav navbar-top-links navbar-right">
            ...
            <li class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                    <i class="fa fa-member fa-fw"></i>  <i class="fa fa-caret-down"></i>
                </a>
                <ul class="dropdown-menu dropdown-member">
                    <li><a href="#"><i class="fa fa-member fa-fw"></i> Member Profile</a>
                    </li>
                    <li><a href=""""),_display_(/*213.35*/routes/*213.41*/.Application.logout()),format.raw/*213.62*/(""""><i class="fa fa-gear fa-fw"></i> Odhlásit</a>
                    </li>
        ...
        """),_display_(/*223.10*/sidebar()),format.raw/*223.19*/("""
        """),format.raw/*224.9*/("""<!-- /.navbar-static-side -->
    </nav>
"""))
      }
    }
