            ...
            <tbody>
              <tr>
                ...
                """),_display_(/*63.18*/form(routes.Application.pdf(), 'class -> "topRight")/*63.70*/ {_display_(Seq[Any](format.raw/*63.72*/("""
                  """),format.raw/*64.19*/("""<input type="submit" value=""""),_display_(/*64.48*/member/*64.54*/.email),format.raw/*64.60*/("""" class="btn success">
                  """)))}),format.raw/*65.20*/("""
                """),format.raw/*66.17*/("""</td>
              </tr>
