...
(function( $, window, document, undefined ) {
	...
	function _fnLanguageCompat( lang )
	{
		...
		if ( ! lang.sEmptyTable && zeroRecords &&
			defaults.sEmptyTable === "V tabulce nejsou k dispozici žádné údaje" )
		{
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *  @type string
			 *  @default V tabulce nejsou k dispozici žádné údaje
			 *
			 *  @dtopt Language
			 ...
			 *    } );
			 */
			"sEmptyTable": "V tabulce nejsou dostupné žádné údaje",
			 ...
			 *    } );
			 */
			"sInfo": "Zobrazeno _START_ z _END_. Celkově _TOTAL_ záznamů.",
			 ...
			 *    } );
			 */
			"sInfoEmpty": "Zobrazno 0 z 0. Celkově 0 záznamů.",
